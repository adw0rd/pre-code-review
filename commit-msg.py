...
Example:
git commit -m "Неполадки в системе приема наличности [XXX-4242] Была исправлена проблема с заглушкой для обменного сервиса (невозможно было установить соединение с удаленным сервером). Добавили временный кеш и несколько дополнительных бекендов + балансировка"
"""
...
def check_task_tracking_system_identificator(message):
    issue_prefix = "XXX"
...
def main(message):
    error = False
    handlers = {check_task_tracking_system_identificator: ''}
